...
Welcome to the **seppalalab** GitHub organization. This guide covers everything lab members need to know to contribute — whether you are editing the lab website or publishing research resources.

## What lives here

| Repository           | Purpose                                                          |
| -------------------- | ---------------------------------------------------------------- |
| `seppalalab_website` | *To be added*                                                    |
| Other repositories   | Research resources: data, code, posters, supplementary materials |

---

## How to join the seppalalab GitHub organization

Before contributing to any repository, you need to be a member of the seppalalab GitHub organization.

### Step 1 — Create a GitHub account (if you do not have one)

1. Go to [github.com](https://github.com) and click **Sign up**
2. Follow the registration steps — a free account is all you need
3. Note down your GitHub username (you will need it in the next step)

### Step 2 — Share your GitHub username

Send your GitHub username via one of these channels:

- **Slack:** post in the lab channel
- **Email:** [tseppalalab@gmail.com](mailto:tseppalalab@gmail.com)

### Step 3 — Wait to be added

You will receive an invitation to join the seppalalab GitHub organization. This usually happens within 1–2 working days.

### Step 4 — Accept the invitation

1. Check your email inbox (the address linked to your GitHub account) for an invitation email from GitHub
2. Click **Join seppalalab** in the email
3. You now have access to the organization and can contribute to repositories

> **If you cannot find the invitation email:** check your spam folder, or go to [github.com/seppalalab](https://github.com/seppalalab) while logged in — the invitation banner may appear there directly.
...
The seppalalab GitHub organization can host supplementary materials for publications, posters, datasets, and code. Keeping these on GitHub (and archiving them to Zenodo for a permanent DOI) makes them citable, persistent, and easy to share.
...
Open an issue in the relevant repository or contact Emmi or email to (tseppalalab@gmail.com).
